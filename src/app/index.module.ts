...
require('highcharts/js/highcharts-more.js');
require('highcharts/js/modules/solid-gauge.js');
require('highcharts/js/modules/no-data-to-display.js');
...
function fetchData() {
  ...
  return $http.get("constants.json").then(function(response: any) {
    angular.module('gravitee').constant("Constants", response.data);
  });
}
